...
def main(*args):
    api = 'http://t.weather.sojson.com/api/weather/city/'             #API地址，必须配合城市代码使用
    city_code = '101040100'               #进入https://where.heweather.com/index.html查询你的城市代码
    tqurl = api + city_code
    ...
    if(d['status'] == 200):     #当返回状态码为200，输出天气状况
        ...
        cpurl = 'https://push.xuthus.cc/group/'+spkey               #自己改发送方式，我专门创建了个群来收消息，所以我用的group
